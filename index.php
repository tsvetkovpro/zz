...
<head>
  ...
  <link rel="apple-touch-icon" href="images/favic//apple-touch-icon.png">
  <link rel="apple-touch-icon" sizes="72x72" href="images/favic/apple-touch-icon-72x72.png">
  <link rel="apple-touch-icon" sizes="114x114" href="images/favic/apple-touch-icon-114x114.png">

  <!-- Chrome, Firefox OS and Opera -->
  <meta name="theme-color" content="#027A3A">
  <!-- Windows Phone -->
  <meta name="msapplication-navbutton-color" content="#027A3A">
  <!-- iOS Safari -->
  <meta name="apple-mobile-web-app-status-bar-style" content="#027A3A">
